...
#include "base/serialization/ptree.hpp"
...
namespace base
{
    namespace property_tree
    {
         ...
         *       guaranteed to be the same as that when using the
         * Boost.PropertyTree library's @c
        ...
        inline void save(Archive &ar, const basic_ptree<K, D, C> &t,
        ...
        namespace detail
        {
            ...
            {
                // namespace bsl = base::serialization;
                // namespace bsa = base::archive;
                ...
                // }
                // // Can't use the serialization helper, it expects resize() to
                // // exist for default-constructible elements. This is a
                // // copy/paste of the fallback version.
                // t.clear();
                // while (count-- > 0)
                // {
                //     bsl::detail::stack_construct<Archive, value_type> u(
                //         ar, item_version);
         ...
         * @note In addition to de-serializing from regular archives, this
         * supports loading from archives requiring name-value pairs, e.g. XML
         *       archives. The format should be that used by
         *       boost::property_tree::save.
         * @param ar The archive from which to load the serialized property
         * tree. This archive should conform to the concept laid out by the
         *           Boost.Serialization library.
         ...
         */
        template <class Archive, class K, class D, class C>
        inline void load(Archive &ar, basic_ptree<K, D, C> &t,
                         const unsigned int file_version)
        {
            // namespace bsl = base::serialization;
         ...
         * @param ar The archive from which to load or save the serialized
         * property tree. The type of this archive will determine whether saving
         * or loading is performed.
         * @param t The property tree to load or save.
         * @param file_version file_version for the archive.
         */
        template <class Archive, class K, class D, class C>
        inline void serialize(Archive &ar, basic_ptree<K, D, C> &t,
                              const unsigned int file_version)
        {
            // using namespace base::serialization;
